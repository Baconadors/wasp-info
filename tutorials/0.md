...
If you would like to use a .bat file that backs up your current Simba and RuneLite install, uninstalls the current Simba and RuneLite versions, and installs the correct versions of Simba and RuneLite - [CLICK HERE](https://github.com/Baconadors/Bacon-Tools/releases/download/1.8/Automated_Force_Update_Tool.bat).
